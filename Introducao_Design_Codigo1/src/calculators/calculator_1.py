...
class Calculator1:
    ...
    def calculate(self, request: FlaskRequest) -> Dict: # type: ignore
        ...
        calc_process_result = splited_number + first_process_result + second_process_result

        response = self.__format_response(calc_process_result)
        return response
    ...
    def __first_process(self, first_number: float) -> float:
        ...
        second_part = (first_number ** 2) * 0.257
